      ...
      <Container>
        <div className="px-5 md:px-10 xl:px-0">
          ...
          <p className="text-[#424B54] text-lg md:text-xl xl:text-2xl leading-6 md:leading-9 mt-5">
            At Student Tiffin, we understand that cravings for authentic Indian
            food can strike any day of the week. That's why we are committed to
            delivering fresh, delicious meals to your table every day from
            Monday to Saturday. Our menu features a range of homestyle dishes,
            inspired by traditional recipes passed down through generations.
            <br />
            <br />
            ...
            we’re here to make your life easier and tastier. Enjoy the
            convenience of healthy, ready-to-eat meals that keep you connected
            to your roots, no matter where you are.
          </p>
